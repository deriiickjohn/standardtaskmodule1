...
import { DescriptionModule1 } from './DescriptionModule1.jsx';
...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentservicesprofile20211009221228.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
    ...
    saveProfile() {
        ...
        $.ajax({
            ...
            url: 'https://talentservicesprofile20211009221228.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                                ...
                                <form className="ui form">
                                    <div className="ui grid">
                                        ...
                                        <FormItemWrapper
                                            ...
                                            <Address
                                                addressData={this.state.profileData}
                                                updateProfileData={this.updateWithoutSave}
                                                saveProfileData={this.updateAndSaveData}
                                            />
                                        </FormItemWrapper>
